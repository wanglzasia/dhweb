...
<%@taglib prefix="s" uri="/struts-tags" %>
	...
	<form name="form" action="/orderConfirmation/orderConfirmationBatch.do" id="cart_frm_settle" method="post">
		...
		<input type="text" name="carts" id="carts"/>
		<input type="text" name="buycounts" id="buycounts"/>
		<input type="text" name="shipfees" id="shipfees"/>
		<input type="text" name="profees" id="profees"/>
		<input type="text" name="singlefees" id="singlefees"/>
		<input type="text" name="sellers" id="sellers"/>
		 	  ...
		 	  <table class="data_list" >
				<tr>
					<td rowspan="3" class="title1">
						<!-- 
						<input onclick="chkSingle(this)" type="checkbox" class="chart_css" pro_id="<s:property value="#map.product_id" />" cart_id="<s:property value="#map.shoppingcart_id"/>" id="product_selected_<s:property value="#map.shoppingcart_id"/>" name="product_selected" value="<s:property value="#map.shoppingcart_id"/>" checked>
						 -->
						<input onclick="chkSingle(this)" type="checkbox" class="chart_css" pro_id="<s:property value="#map.product_id" />" name="product_selected"  value="<s:property value="#map.shoppingcart_id"/>" checked />
					...
					<td rowspan="3" class="tail">
						<a href="javascript:deleteProduct('<s:property value="#map.shoppingcart_id"/>');">Remove</a>
					</td>
				...
				<tr>
				  ...
				  <div id="<s:property value="#map.shoppingcart_id"/>_<s:property value="#map.product_id" />">&nbsp;</div>
				...
				<tr>
					<td colspan="5" class="bottom_style">
						...
						<textarea maxlength="2000" style="width:500px;" name="remark_<s:property value="#map.product_id"/>">Please add remark:(e.g. color, size...)</textarea>
						<p></p>					
					</td>
				</tr>
