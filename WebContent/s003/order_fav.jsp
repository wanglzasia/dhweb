...
.order_title2{line-height:20px;margin-top:20px;}
 ...
 <div>
 	...
 	<s:iterator var="map" value="#request.list">  
	 	...
	 	<form action="/seller/chgorderp.do" method="post">
		 	...
		 	<div  class="order_title2" style="text-align:right;"> 
		 				...
		 				<div style="color:#FF4400;">-订单优惠：$
		 				<input type="text" value="<s:property value="#map.fav_price" />" name="fav_value" id="fav_price_id" style="width:40px;" onchange="chgfav('<s:property value="#map.order_id" />')">
		 				...
		 				<div><input type="submit" value="调整订单优惠" /> </div>
		 	</div>
		</form>
