...
<form action="#" method="post">
	...
	<div class="add_pro_title">基本信息</div>
		<div class="pro_item"><label>商品分类:</label><p>通讯产品->手机->智能机</p>
			<input type="hidden" name="pro_kind" value="PRODUCT_PHONE"/></div>
		...
		<div class="pro_item"><label>产品属性:</label>
			<div class="multi_opr_area">
				<div class="price_box">
					<ProAttr:ProAttr type="1" usr="1" kindCode="${kindcode}" ></ProAttr:ProAttr>
				</div>
			</div>
		</div>		
	...
	<div class="pro_item"><label>备货数量:</label>
		<div class="multi_opr_area">
			<input type="text" style="width:50px;" name="pro_prepare_count"/>
		</div>
	</div>
	<div class="pro_item"><label>备货周期:</label>
		<div class="multi_opr_area">
		  	<input type="text" style="width:50px;" name="pro_prepare_day" />&nbsp;&nbsp;天
		 </div>
	</div>
	
	<div class="pro_item">
	
		<label style="padding-top:10px;padding-left:10px;">产品价格:</label>
				...
				<div style="padding-bottom:10px;">
			 	...
			 	<div id="price_cell_box">
					<div class="multi_opr_area" style="padding-bottom:5px;">
						购买数量:<input type="text" style="width:100px;" value="999999" name="pro_buy_count"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						购买价格:<input type="text"  style="width:80px;" value="" name="pro_buy_price"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $(美元)
					</div>
				</div>
	...
	<div class="pro_item"><label></label>
		<div class="multi_opr_area">
			...
			<div class="picture_box" ondblclick="upload('1',400,200)" id="single_pic1">双击,上传图片</div>
			<div class="picture_box" ondblclick="upload('2',400,200)" id="single_pic2">双击,上传图片</div>
			<div class="picture_box" ondblclick="upload('3',400,200)" id="single_pic3">双击,上传图片</div>
			<div class="picture_box" ondblclick="upload('4',400,200)" id="single_pic4">双击,上传图片</div>
			<div class="picture_box" ondblclick="upload('5',400,200)" id="single_pic5">双击,上传图片</div>
			<div class="picture_box" ondblclick="upload('6',400,200)" id="single_pic6">双击,上传图片</div>
			
			<div class="picture_box1"><!-- <a href="javascript:load_ablum('1')">相册中选择</a>--></div>
			<div class="picture_box1"><!-- <a href="javascript:load_ablum('2')">相册中选择</a>--></div>
			<div class="picture_box1"><!-- <a href="javascript:load_ablum('3')">相册中选择</a>--></div>
			<div class="picture_box1"><!-- <a href="javascript:load_ablum('4')">相册中选择</a>--></div>
			<div class="picture_box1"><!-- <a href="javascript:load_ablum('5')">相册中选择</a>--></div>
			<div class="picture_box1"><!-- <a href="javascript:load_ablum('6')">相册中选择</a>--></div>
			<!--
	...
	<div class="pro_item"><label>详细描述:</label>
		...
		<div class="multi_opr_area">
			<textarea cols='50' rows='6' name='pro_detail_descript' id='pro_detail_descript'>Default Value</textarea>
		</div>
	</div>	 
	...
	<div class="pro_item"><label>包装尺寸:</label>
		<div class="multi_opr_area">
			长<input type="text" style="width:30px" name="pro_package_length"/> 厘米
			&nbsp;&nbsp;&nbsp;&nbsp;宽<input type="text" style="width:30px" name="pro_package_width"/> 厘米
			&nbsp;&nbsp;&nbsp;&nbsp;高<input type="text" style="width:30px" name="pro_package_height"/> 厘米 
		</div>
	</div>
		<div class="pro_item"><label>包装重量:</label>
		<div class="multi_opr_area">
			<input type="text" style="width:60px" name="pro_package_weight"/>&nbsp;&nbsp;&nbsp;&nbsp;公斤(KG)/件
		</div>
	</div>
	...
	<br><br><br>
		<!-- 
	<input type="checkbox" checked />同意接受<a href="#">《xx网产品发布规则》</a><br><br>

	<div style="text-align:center;"><input type="button" value="同意《产品发布规则》,提交产品" /></div>
	 -->
